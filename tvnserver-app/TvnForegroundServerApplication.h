...
#ifndef _TVN_FOREGROUND_SERVER_APPLICATION_H_
#define _TVN_FOREGROUND_SERVER_APPLICATION_H_
...
/**
 * Windows TightVNC foreground server application.
 * Used for running TightVNC server in foreground.
 */
class TvnForegroundServerApplication : public WindowsApplication,
...
public:
   ...
   */
  TvnForegroundServerApplication(HINSTANCE hInstance,
   ...
   */
  virtual ~TvnForegroundServerApplication();
...
private:
   ...
   * TightVNC server.
   */
  TvnForegroundServer *m_tvnServer;
  /**
